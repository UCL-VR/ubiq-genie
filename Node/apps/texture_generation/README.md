...
1. In Unity, open the `TextureGeneration.unity` scene. If you installed the package via git URL (UPM), you first need to import the **Texture Generation** sample from **Window → Package Manager → Ubiq-Genie → Samples**.
