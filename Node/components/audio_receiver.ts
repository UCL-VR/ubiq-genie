...
class AudioReceiver extends EventEmitter {
    ...
    constructor(scene: any) {
        ...
        this.peerConnectionManager.addListener("OnPeerConnection", async component =>{
            ...
            component.addListener("OnSignallingMessage", async (m: { implementation: any; type: any; sdp: any; candidate: any; sdpMid: any; sdpMLineIndex: any; usernameFragment: any; }) => {                
                // Special handling for dotnet peers
                ...
                switch(track.kind){
                    case 'audio':
                        ...
                        audioSink.ondata = (data: RTCAudioData) => {
                            // console.log("Data received for uuid: ", component.uuid, " with data: ", data);
