...
If you have cloned the full repository, this package is included as an [embedded package](https://docs.unity3d.com/Manual/CustomPackages.html) under `Packages/com.ucl.ubiq-genie/` — no extra steps are needed. Open the `Unity` folder in Unity Hub to get started. Samples are directly accessible in the Project window under `Packages/Ubiq-Genie/Samples/`.
...
Samples/                        Importable sample scenes and scripts
```
